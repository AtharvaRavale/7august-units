                      ...
                      <>
                        ...
                        {selectedCategory && availableLevel1.length > 0 && (
                          <div className="grid grid-cols-3 gap-3 items-center">
                            ...
                            >
                              <option value="">
                                Select Sub-Category 1 (Optional)
                              </option>
                              {availableLevel1.map((item) => (
                                <option key={item.id} value={item.id}>
                                  {item.name}
...
Sub-Category 2                            </label>
                            ...
                            >
                              <option value="">
                                Select Sub-Category 2 (Optional)
                              </option>
                              {availableLevel2.map((item) => (
                                <option key={item.id} value={item.id}>
                                  {item.name}
                        ...
                        {selectedLevel2 && availableLevel3.length > 0 && (
                          <div className="grid grid-cols-3 gap-3 items-center">
                            ...
                            >
                              <option value="">
                                Select Sub-Category 3 (Optional)
                              </option>
                              {availableLevel3.map((item) => (
                                <option key={item.id} value={item.id}>
                                  {item.name}
                        ...
                        {selectedLevel3 && availableLevel4.length > 0 && (
                          <div className="grid grid-cols-3 gap-3 items-center">
                            ...
                            >
                              <option value="">
                                Select Sub-Category 4 (Optional)
                              </option>
                              {availableLevel4.map((item) => (
                                <option key={item.id} value={item.id}>
                                  {item.name}
                        ...
                        {selectedLevel4 && availableLevel5.length > 0 && (
                          <div className="grid grid-cols-3 gap-3 items-center">
                            ...
                            >
                              <option value="">
                                Select Sub-Category 5 (Optional)
                              </option>
                              {availableLevel5.map((item) => (
                                <option key={item.id} value={item.id}>
                                  {item.name}
                        ...
                        {selectedLevel5 && availableLevel6.length > 0 && (
                          <div className="grid grid-cols-3 gap-3 items-center">
                            ...
                            >
                              <option value="">
                                Select Sub-Category 6 (Optional)
                              </option>
                              {availableLevel6.map((item) => (
                                <option key={item.id} value={item.id}>
                                  {item.name}
